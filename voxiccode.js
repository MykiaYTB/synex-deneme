      ...
      .then(() => {
        ...
        message.channel.send(
          new Discord.MessageEmbed()
            ...
            .setColor("PURPLE")
            .setDescription(
              "**<:lyrix:837621379116695552> Projeniz Uptime Edilmeye Başlandı ,Daha Önceden Eklediğin Linklere Bakmak İçin `+göster` yaz.**"
            )
        );
      ...
      .catch(e => {
        return message.channel.send(
          new Discord.MessageEmbed()
            ...
            .setColor("PURPLE")
            .setDescription(
              "**<:lyrix:837621379116695552> Lütfen Kabul Edilen  bir URL gir.**"
            )
            .setImage("")
        );
      });
...
client.on("message", message => {
  ...
  if (spl[0] == "ly!yardım") {
    ...
    const help = new Discord.MessageEmbed()
      ...
      .setDescription(
        `**<:lyrix:837621379116695552> Selam Dostum, Discord Botunu 7/24 Yapmakmı İstiyorsun Bunu Yapmak için yapman gerekenleri  sana Teker Teker Yazacağım.** \n\n <:lyrix:837621379116695552>  **  Artık Çok daha kolay bir şekilde botunu uptime edebilirsin! **\n\n **<:lyrix:837621379116695552> \`+ekle\` yazarak botunu 7/24 aktif  edebilirsin.** \n\n  **<:lyrix:837621379116695552> \`+göster\` yazarak toplam 7/24 uptime ettiğim bot  sayısını görebilirsin.** \n\n  **<:lyrix:837621379116695552> Eğer botunu uptimeden kaldırmak istiyorsan Voxice Veya Gravitye ulaşabilirsin. **\n\n  ** <:lyrix:837621379116695552>  \`+davet\` yazarak Voxic Code Uptime botunu sunucuna davet edebilirsin. **\n\n ** <:lyrix:837621379116695552> \`+erişim-kontrol\` yazarak bota erişiminizin olup olmadığını kontrol edebilirsin.** **\n\n <:lyrix:837621379116695552> \`+i\` yazarak bot istatistiklerini öğrenebilirsin.** **\n\n <:lyrix:837621379116695552> \`+youtube\` yazarak Voxicin YouTube kanalına ulaşabilirsin.** **\n\n<:lyrix:837621379116695552> \`+linkler\` yazarak __yeni eklenen__ uptime linklerinizi görüntüleyebilirsiniz.**`
      )
      .setImage(
  ...
  if (spl[0] == "+erişim-kontrol") {
    ...
    message.channel.send(
      new Discord.MessageEmbed()
        ...
        .setColor("PURPLE")
        .setDescription(
          `**» <:lyrix:837621379116695552> Bota erişiminiz aktif! Botumuzda Database Bulunmamaktadır Bize Güvenebilirsiniz  Çalınma Durumu Gibi Bir Durum Asla Olamaz Botlarınızı Güvenle 7/24 Edebilirsiniz !**`
        )
    );
  }
});
